...
def get_status(guild, yt):
    ...
    statuses = [
        ...
        f"Thank you for boosting {choice(guild.get_role(892475435290607646).members).nick}!",
        "Blue is the best color",
        f"Hello {choice(guild.get_role(893933214656233563).members).nick}, thanks for being in our server",
